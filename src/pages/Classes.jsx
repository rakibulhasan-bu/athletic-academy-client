      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-red-300 to-yellow-200 py-20">
        <div className="gap-5 space-y-4 md:grid md:grid-cols-2 md:space-y-0 md:px-4 lg:grid-cols-3">
          ...
          {/* <div className="max-w-sm transform rounded-xl bg-white px-6 pb-2 pt-6 shadow-lg transition duration-500 hover:scale-105">
            ...
            <h1 className="mt-4 cursor-pointer text-2xl font-bold text-gray-800">
            ...
            <div className="my-4">
              <div className="flex items-center space-x-1">
                <span>
                  <svg
                    ...
                    className="mb-1.5 h-6 w-6 text-indigo-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <button className="mt-4 w-full rounded-xl bg-indigo-600 py-2 text-xl text-white shadow-lg">
                Buy Lesson
              </button>
            </div>
          </div> */}
          ...
          {courses.map((course) => {
            <div
              key={course._id}
              className="max-w-sm transform rounded-xl bg-red-500 px-6 pb-2 pt-6 shadow-lg transition duration-500 hover:scale-105"
            >
              <h3 className="mb-3 text-xl font-bold text-indigo-600">
                name here
              </h3>
              <div className="relative">
                ...
                <p className="absolute right-0 top-0 rounded-bl-lg rounded-tr-lg bg-yellow-300 px-3 py-1 font-semibold text-gray-800">
                  %20 Discount
                </p>
              </div>
              <h1 className="mt-4 cursor-pointer text-2xl font-bold text-gray-800">
